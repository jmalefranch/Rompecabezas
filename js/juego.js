...
var instrucciones = ['Utilizá las flechas del teclado para mover las piezas.', 'Tenés que ir ordenando las piezas, hasta que la imágen quede como la que ves acá abajo↓'];
...
y usa actualizarUltimoMovimiento para mostrarlo en pantalla */
...
function mostrarCartelGanador() {
  alert('¡Ganaste! \n utilizaste ' + movimientos.length + ' movimientos para conseguirlo!.');
  var pregunta = prompt('¿Querés volver a jugar? \n1. Si \n2. No');
  switch (pregunta) {
    case "1":
    mezclarPiezas(30);
    break;
